...
namespace Step3
{
  ...
  ///   
  ///   This class is ONLY responsible for writing messages to a writer 
  ///   (no longer console or file specific).
  /// 
  ///   NOTE: The name was changed from ConsoleMessageSender to just MessageSender to 
  ///   reflect that the dependencies are removed and it no has a dependency on the console.
  /// </summary>
